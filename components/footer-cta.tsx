...
export default function FooterCTA() {
  return (
    <section className="bg-blue-950 py-12 px-6 md:px-16 flex flex-col items-center justify-center gap-8" style={{ backgroundColor: '#191970' }}>
      {/* Título */}
      <motion.h2
        ...
        className="text-3xl md:text-4xl font-bold text-center bg-gradient-to-r from-yellow-300 to-yellow-500 bg-clip-text text-transparent"
      >
      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center items-center">
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.98 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 sm:px-8 py-3 bg-yellow-500 hover:bg-yellow-600 text-blue-950 font-bold text-base rounded-full shadow-lg transition-colors duration-300 touch-manipulation"
        >
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.98 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="w-full sm:w-auto px-6 sm:px-8 py-3 border border-yellow-500 bg-transparent hover:bg-yellow-500 hover:text-blue-950 text-yellow-400 font-extrabold rounded-full backdrop-blur-sm transition-colors duration-300 text-center text-2xl touch-manipulation"
        >
