      ...
      >
        ...
        <p className="text-gray-300 text-sm md:text-base flex items-center justify-center gap-2">
          <svg className="h-5 w-5 text-amber-600" fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 0C5.37 0 0 5.37 0 12c0 6.63 5.37 12 12 12s12-5.37 12-12S18.63 0 12 0zm0 22C6.48 22 2 17.52 2 12S6.48 2 12 2s10 4.48 10 10-4.48 10-10 10z" />
          </svg>
          <a href="https://instagram.com/dedetizadora.sh" target="_blank" rel="noopener noreferrer" className="hover:text-amber-600 transition-colors">
            @dedetizadora.sh
          </a>
        </p>
      </motion.div>
